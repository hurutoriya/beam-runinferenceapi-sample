# Copy from https://github.com/apache/beam/blob/master/sdks/python/apache_beam/examples/inference/sklearn_mnist_classification.py
#
...
from apache_beam.ml.inference.sklearn_inference import (
    ModelFileType, SklearnModelHandlerNumpy)
